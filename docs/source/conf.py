...
# -*- coding: utf-8 -*-
#
# widget_test documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget_test', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'widget_testdoc'
...
latex_documents = [
    (master_doc, 'widget_test.tex', 'widget_test Documentation',
     'Json Woo', 'manual'),
]
